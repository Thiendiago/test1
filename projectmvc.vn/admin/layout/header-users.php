                    ...
                    <div class="wp-inner clearfix">
                        ...
                        <ul id="main-menu" class="fl-left">
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=pages&controller=index&action=add" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                            ...
                            <li>
                                <a href="?mod=posts&controller=index&action=index" title="">Bài viết</a>
                                <ul class="sub-menu">
                                    <li>
                                        <a href="?mod=posts&controller=index&action=add" title="">Thêm mới</a> 
                                    </li>
                                    <li>
                                        <a href="?mod=posts&controller=index&action=index" title="">Danh sách bài viết</a> 
                                    </li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <div id="dropdown-user" class="dropdown dropdown-extended fl-right">
                            <button class="dropdown-toggle clearfix" type="button"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                ...
                                <h3 id="account" class="fl-right"></h3>
                            </button>
